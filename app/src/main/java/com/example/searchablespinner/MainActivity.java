...
import com.example.searchablespinner.dependentpages.KeyPairBoolData;
import com.example.searchablespinner.dependentpages.MultiSpinnerSearch;
import com.example.searchablespinner.dependentpages.SingleSpinnerListener;
import com.example.searchablespinner.dependentpages.SingleSpinnerSearch;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final List<String> list = Arrays.asList(getResources().getStringArray(R.array.android_array));
		...
		singleSpinnerSearch.setSearchHint("Select");
		...
		// A text that will display in search hint.
		multiSelectSpinnerWithSearch.setSearchHint("Select");
